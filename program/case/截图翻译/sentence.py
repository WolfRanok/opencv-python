...
class sentence:
    ...
    def image_init(self, img=None):
        ...
        if self.debug:
            ...
            for contour in contours:
                show_img = cv2.rectangle(show_img, contour[0], contour[1], (0, 0, 255), 2)
            self.show(show_img)
    ...
    def get_pictures(self, img=None):
        """
        用于返回截取结果的集合
        :return: zip
        """
        ...
        return zip(self.result_imgs, self.contours)
